...
use App\Http\Requests\ArticleRequest;  //请求层
use App\Http\Controllers\Controller;
use Illuminate\Http\Request;
use App\Repositories\ContentRepository;  //模型仓库层
use App\Repositories\FlagRepository;  //推荐位仓库层
...
class AdminArticleController extends BackController
{
     ...
     *
     * @var App\Repositories\FlagRepository
     */
    protected $flag;
