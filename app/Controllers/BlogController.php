...
class BlogController extends CommonController
{
    ...
    public function getIndex()
    {
        ...
        $title = '首页';
        $description = '芽丝内容管理框架，基于Laravel 5开发而成，它比较适合拿来做一些小众项目开发。目前框架实现了一个简单的内容管理系统（CMS），支持多种内容模型，文章、单页、分类、碎片与标签，您现在完全可以拿它来完成一个简单的博客网站，“芽丝博客”就是它所驱动的博客示例网站。Github地址： https://github.com/App/yascmf 。';  //追加seo描述Meta信息
    ...
    public function getCategoryArticles($slug)
    {
        ...
        if ($category) {
            ...
            $description = Cache::get('website_title', '芽丝博客').'-'.$title.'，  '.$category->description.'  本博客由 芽丝内容管理框架(YASCMF) 所驱动的博客，基于Laravel实现的内容管理框架，Github地址： https://github.com/App/yascmf 。';
    ...
    public function getPageShow($slug)
    {
        ...
        if ($page) {
            $title = $page->title;
            $description = Cache::get('website_title', '芽丝博客').' - '.$title.'，本博客由 芽丝内容管理框架(YASCMF) 所驱动的博客，基于Laravel实现的内容管理框架，Github地址： https://github.com/App/yascmf 。';
